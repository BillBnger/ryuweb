...
export const RoadmapItem = (props) => {
  ...
  const dotContent = (
    <div className="timeline-dot-content ">
      <div className="sticky-dot d-flex align-items-center justify-content-center">
        {progress}
      </div>
    </div>
  );
  ...
  if (useWindowWidth() <= 600) {
    return (
      <div className="row align-items-center timeline-item">
        ...
        <div className="col-md-6 border-right left timeline-container d-flex align-items-start"></div>
  ...
  if (align === "right") {
    return (
      <div className="row align-items-center timeline-item">
        <div className="col-md-6 border-right left timeline-container d-flex align-items-start">
