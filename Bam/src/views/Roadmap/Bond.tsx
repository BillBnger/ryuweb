    ...
    <Switch>
      ...
      <Container>   
              <Grid item xs={12} md={12} lg={12} >     
                  ...
                  <p style={{ fontSize: '20px', textAlign:'center', color: '#fff' }}>- Start weekly Bam burns from the DAO ✅</p>   
                  <p style={{ fontSize: '20px', textAlign:'center', color: '#fff' }}>- Bdao governance voting through snapshot ✅</p>      
                  <p style={{ fontSize: '20px', textAlign:'center', color: '#fff' }}>- Integrate weekly Bdao raffle on site ✅</p>                  
                  <p style={{ fontSize: '20px', textAlign:'center', color: '#fff' }}>- NFT drop for LPs & BDAO hodlers providing exclusive access to new developments ✅</p> 
                  <p style={{ fontSize: '20px', textAlign:'center', color: '#fff' }}>- Launchpad & partnerships with projects to give exclusive benefits for BDAO holders ✅</p>
                  ...
                  <p style={{ fontSize: '20px', textAlign:'center', color: '#fff' }}>- Lending & borrowing of Bam & Bdao on site</p>
                  ...
                  <p style={{ fontSize: '20px', textAlign:'center', color: '#fff' }}>- Implement cross chain Bam liquidity</p>
                  <p style={{ fontSize: '20px', textAlign:'center', color: '#fff' }}>- Integrate Bam on large lending platforms as a stablecoin</p>
                  ...
                  <p style={{ fontSize: '20px', textAlign:'center', color: '#fff' }}>- Dedicated mobile app for Bamboo Finance</p>
                  <p style={{ fontSize: '20px', textAlign:'center', color: '#fff' }}>- Partner with crypto payment gateways to accept Bam</p>
