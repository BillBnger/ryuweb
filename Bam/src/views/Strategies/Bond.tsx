...
<Page>
  <BackgroundImage />  
     <Grid item xs={12} md={12} lg={12} >     
                  ...
                  <p style={{ fontSize: '20px', textAlign:'center', color: '#fff' }}>Depending on the TWAP price of Bam there are different optimal strategies for protocol health. <br></br>All strategies can be found in our <a target={"_blank"} href="https://bamfinance.gitbook.io/bam-finance-docs/protocol/strategies" >docs here.</a></p>
                  <p style={{ fontSize: '20px', textAlign:'center', color: '#fff' }}>Bam TWAP: ${bondScale}</p>
