...
const Boardroom = () => {
  ...
  const stakedTokenPriceInDollars = useStakedTokenPriceInDollars('BDAO', bamFinance.BDAO);
    ...
    <Page>
      ...
      {!!account ? (
        <>
            ...
            <h2 style={{ fontSize: '80px', textAlign:'center', color:'#fff' }}>Boardroom</h2>

           {/* <Alert variant="filled" severity="info" >               
   The BDAO does not print Bam when below 1.01 TWAP, staking here below 1.01 TWAP will not generate rewards. Staked BDAO can only be withdrawn every 4 epochs (24hrs) & rewards claimed every 2 epochs (12hrs). Staking or claiming resets this timer.
      </Alert>  */}
          <Box mt={5}>
            ...
            <Grid container justify="center" spacing={3}>
              <Grid item xs={12} md={2} lg={2} className={classes.gridItem}>
                <Card className={classes.gridItem}>
                  <CardContent style={{textAlign: 'center'}}>
                    <Typography style={{textTransform: 'uppercase', color: '#44a742'}}>Next Epoch</Typography>
              ...
              <Grid item xs={12} md={2} lg={2} className={classes.gridItem}>
                <Card className={classes.gridItem}>
                  <CardContent align="center">
                    <Typography style={{textTransform: 'uppercase', color: '#44a742'}}>Epoch / TWAP</Typography>
                    <Typography>{Number(currentEpoch)} / {scalingFactor} USDC</Typography>
                  </CardContent>
                </Card>
              </Grid>
              <Grid item xs={12} md={2} lg={2} className={classes.gridItem}>
                <Card className={classes.gridItem}>
                  <CardContent align="center">
                    <Typography style={{textTransform: 'uppercase', color: '#44a742'}}>APR / Daily</Typography>
              ...
              <Grid item xs={12} md={2} lg={2}>
                <Card className={classes.gridItem}>
                  <CardContent align="center">
                    <Typography style={{textTransform: 'uppercase', color: '#44a742'}}>Staked / %</Typography>
              ...
              <Grid item xs={12} md={2} lg={2}>
                <Card className={classes.gridItem}>
                  <CardContent align="center">
                    <Typography style={{textTransform: 'uppercase', color: '#44a742'}}>TVL</Typography>
              ...
              <Grid item xs={12} md={2} lg={2}>
                <Card className={classes.gridItem}>
                  <CardContent align="center">
                    <Typography style={{textTransform: 'uppercase', color: '#44a742'}}>Est Reward/Day</Typography>
