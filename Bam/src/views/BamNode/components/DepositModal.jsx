    ...
    <Modal>
      ...
      />
        ...
        <div style={{ display: 'flex', justifyContent: 'space-evenly' }}>
          {/* {numNodes.map((num, i) => {
            return (<>
              <Button data-tip={`${getDisplayBalance(nodePrice.mul(num), 18, 0)} BAM`} style={{ whiteSpace: 'nowrap', marginRight: i === numNodes.length - 1 ? '0' : '1rem' }} className="shinyButtonSecondary" onClick={() => onConfirm(num.toString())}>
