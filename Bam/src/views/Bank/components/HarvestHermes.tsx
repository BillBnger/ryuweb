...
import BdaoImage from '../../../assets/img/bdao.png';
...
const Harvest: React.FC<HarvestProps> = ({bank}) => {
  ...
  const tokenName = 'BDAO';
  const tokenName2 = 'HSHARE';
  //const tokenStats = bank.earnTokenName === 'BDAO' ? tShareStats : hermesStats;
    ...
    <Card>
      ...
      <Grid item xs={12} sm={12} lg={6}>  
        ...
        <div style={{width: '70px', margin:'0 auto'}}>
         <img src={BdaoImage} width={'70px'} style={{width: '70px', margin:'0 auto'}}/>
         </div>
    
      <Typography style={{textTransform: 'uppercase', color: '#44a742',textAlign:'center'}}>  
            <Value value={'0'} />
            </Typography>
