    ...
    <Switch>
      ...
      <Container>   
              <Grid item xs={12} md={12} lg={12} >     
                  ...
                  <p style={{ fontSize: '20px', textAlign:'center', color: '#fff' }}>We're working hard to secure partnerships with the best up and coming projects on Avalanche to give our BDAO holders and LPs exclusive access and unique benefits. Our launchpad will include access to whitelists, IDOs, membership rights and other unique deals we think will benefit the community.</p>
                  <p style={{ fontSize: '20px', textAlign:'center', color: '#fff' }}>The Bam DAO plans on building a strong community led launchpad to foster growth on Avalanche. We'll be partnering with projects that are building something new, unique and beneficial to the ecosystem to help bolster their launch, their community and achieve their roadmap goals.</p>   
                  <p style={{ fontSize: '20px', textAlign:'center', color: '#fff' }}>If you are launching a new and exciting project on Avalanche and would like to be part of our launchpad get in touch with the core team through our <a href="https://discord.gg/mZ4QrZwH5M" rel="noopener noreferrer" target="_blank" >Discord</a> or <a href="https://t.me/BamDefi" rel="noopener noreferrer" target="_blank" >Telegram</a>.</p> 
        ...
        <Grid container justify="center" spacing={3} style={{marginTop: '10px'}}>
          <Grid item xs={12} sm={12} lg={6} >  
            <Card style={{padding:'30px'}}>
                  ...
                  <p style={{ fontSize: '20px', textAlign:'center', color: '#000' }}>BDAO holders will be able to pledge their tokens to the Asgard DAO in return for VOLT, this can then be locked in their forge to get AMP & then wrapped. The wrapped token WAMP can then be staked in the Vineyard to earn more BDAO!</p>
          ...
          <Card style={{padding:'30px'}}>
                  ...
                  <p style={{ fontSize: '20px', textAlign:'center', color: '#000' }}>Together we'll create a new pair HSHARE-BDAO which then can be staked on either of our sites to earn two different reward tokens at the same time! Reward tokens will also vary & include both native & non-native rewards.</p>
